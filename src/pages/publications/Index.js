            ...
            <PageMeta {...meta} />
                ...
                <header className={headerBg}>
                    <CategoryHeaderBanner 
                        ...
                        Icon={<PiBookBold />}
                    />
                    <AESLPublicationsNav navShadow={navShadow} 
                        navText={footerText} 
                        navBg={navBg} 
                    />
                </header>
                ...
                <main className="ph1-00">
                    ...
                    >
                        {/* Controls */}
                        <header className="gc1s12 gc2s10-m gr1s1 
                            pv4-00 
                            blue0 
                            f1-25-s f1-50-m lh-copy tracked tj"
                        >
                            <p>
                        ...
                        <div className="gc1s12 gr3s1">
                            {
                                filtered.length === 0 ? (
                                    <div className="tc pa2-00"
                                    >
                                        No publications found.
                                    </div>
                                ) : (
                                    <ul className="grid gtc1 gtc2-s gtc3-l ggap1-00 
                                        pa0 list blue0"
                                    >
                                        {
                                            filtered.map(
                                                pub => (
                                                    ...
                                                    >
                                                        ...
                                                        <p className="f0-90 gray0 mb1-00"
                                                        >
                                                            {pub.description}
                                                        </p>
                                                        ...
                                                        >
                                                            {
                                                                pub.fileUrl && (
                                                                    <a href={pub.fileUrl} 
                                                                        ...
                                                                        className="pa0-50 ba br0-25 bg-green blue0 flex items-center"
                                                                        >
                                                                        <FiDownload className="mr0-25" /> 
                                                                        Download
                                                                    </a>
                                                                )
                                                            }
                ...
                {/* Page Footer Start */}
                <footer>
                    <AESLPageFooter pageTitle='Publications' 
