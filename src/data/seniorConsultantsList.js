...
// Auto-generate senior consultants list from staff records
const seniorConsultantsList = staff
  .filter(
    s => (s.currentRank && s.currentRank.toLowerCase().includes('senior consultant'))
  )
  .map((s, idx) => ({
    id: idx + 1,
    staffId: s.id,
...
export default seniorConsultantsList;
